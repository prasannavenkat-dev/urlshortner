...
for(i=0;i<linkList.length;i++){
  ...
  <div class="col-lg-3 m-4" >
      ...
      <div class="card-header"><a style="text-decoration:none" href="https://theurlshortner.herokuapp.com/`+linkList[i].shortUrl+`"target="_blank"><h6 class="card-title mb-0 p-2">http://localhost:3000/${linkList[i].shortUrl}</h6></a></div>
